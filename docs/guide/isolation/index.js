...
__name(this,"Adapter")}static cssProcess(css){return stylis(css)}};var ElementA=class extends Adapter{static{__name(this,"ElementA")}},ElementB=class extends AdapterMixin(
IsolatorMixin(HTMLElement)){static{__name(this,"ElementB")}};customElements.define(
"el-a",ElementA);customElements.define("el-b",ElementB);var test=new ElementA;test=
test.isolate("closed");document.body.append(test);
