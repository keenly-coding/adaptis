...
this),this._adapter}static cssProcess(css){return css}static set css(css){this.adapter.
style=css}static get css(){return this.adapter.style}static get tagName(){return this.
...
__name(this,"Adapter")}static cssProcess(css){return stylis(css)}};var Card=class extends Adapter{static{__name(this,"Card")}};Card.css=`
    display: inline-flex;
    box-sizing: border-box;
    border: 1px solid;
    border-radius: 5px;
    padding: 1rem;
`;Card.define("el-card");var BlueCard=class extends Card{static{__name(this,"Blu\
eCard")}};BlueCard.css=`
    background-color: blue;
    color: white;
`;customElements.define("el-bluecard",BlueCard);BlueCard.addStyle(`
...
`);var ShadowHost=class extends Adapter{static{__name(this,"ShadowHost")}constructor(){
super();let innerHTML=this.innerHTML;this.attachShadow({mode:"open"}),this.shadowRoot.
innerHTML=innerHTML}};customElements.define("el-shadow-host",ShadowHost);
